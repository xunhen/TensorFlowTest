...
def _create_losses(input_queue, create_model_fn, train_config, need_rpn=True):
    ...
    (images, _, groundtruth_boxes_list, groundtruth_classes_list,
     ...
     groundtruth_weights_list, rpn_box,rpn_class) = get_inputs(
        input_queue,
    ...
    # ????
    if not config.need_rpn:
        detection_model.provide_rpn_box(rpn_box,rpn_class)
